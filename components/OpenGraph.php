	...
	public function __construct(){
		...
		Yii::$app->view->on(View::EVENT_BEGIN_PAGE, function(){
			...
			if($this->image!==null){
				...
				Yii::$app->controller->view->registerMetaTag(['property'=>'og:image:width', 'content'=>$this->imageWidth], 'og:image:width');
				Yii::$app->controller->view->registerMetaTag(['property'=>'og:image:height', 'content'=>$this->imageHeight], 'og:image:height');
			}
